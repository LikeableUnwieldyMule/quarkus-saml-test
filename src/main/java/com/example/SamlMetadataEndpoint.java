...
public class SamlMetadataEndpoint {
    ...
    private String generateMetadata() {
        String entityId = "https://quarkus-saml-test-d9apgdavfvewhyhf.centralus-01.azurewebsites.net";
        String acsUrl = "https://quarkus-saml-test-d9apgdavfvewhyhf.centralus-01.azurewebsites.net/saml/acs";
        String sloUrl = "https://quarkus-saml-test-d9apgdavfvewhyhf.centralus-01.azurewebsites.net/saml/logout"; // Optional
